...
JOIN salesforce.account a ON a.sfid = o.accountId
JOIN salesforce.recordtype rt ON rt.sfid=o.RecordTypeId
JOIN salesforce.account p ON p.sfid = o.Partner_Account__c
JOIN salesforce.servicecontract sc ON sc.sfid = o.service_contract__c
JOIN salesforce.account rs ON rs.sfid = o.SoldToAccount__c
JOIN salesforce.contact ct ON ct.sfid = sc.ContactId
JOIN salesforce.account cta ON cta.sfid = ct.AccountId where o.Opportunity_Type__c='Renewal' and o.agreement_number__c = $1