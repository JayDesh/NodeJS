...
var _ = require('underscore'),
    debug = require('debug')('adsk:opportunity:pgcluster'),
    logger = require('./utility.js');
pg.defaults.poolSize = process.env.PGBOUNCER_DEFAULT_POOL_SIZE || 100;//Increasing the pool size
var defaultOptions = {
